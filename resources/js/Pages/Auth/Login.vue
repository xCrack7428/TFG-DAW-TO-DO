                ...
                <div class="mt-6">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-[#181820] text-gray-400">O continúa con</span>
                        </div>
                    </div>

                    <!-- BOTONES SOCIALES -->
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        <a href="/auth/google/redirect" class="w-full flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-700 rounded-md bg-[#13131A] text-sm font-medium text-gray-300 hover:bg-gray-800 transition-colors">
                        ...
                        <a href="/auth/github/redirect" class="w-full flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-700 rounded-md bg-[#13131A] text-sm font-medium text-gray-300 hover:bg-gray-800 transition-colors">
